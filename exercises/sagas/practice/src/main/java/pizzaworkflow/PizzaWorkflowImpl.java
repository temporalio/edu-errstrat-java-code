...
public class PizzaWorkflowImpl implements PizzaWorkflow {
  ...
  public OrderConfirmation orderPizza(PizzaOrder order) {
    ...
    try {
      // TODO Part B: Study how a compensation is added to the Saga object
      ...
      // TODO Part B: Add a compensation for the following Activity to the 
      creditCardConfirmation = activities.processCreditCard(creditCardInfo, bill);
    } catch (ActivityFailure e) {
      // TODO Part B: Add the compensate call using the saga object
